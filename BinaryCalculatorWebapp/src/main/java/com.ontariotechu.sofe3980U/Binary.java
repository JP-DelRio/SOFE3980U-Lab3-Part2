...
public class Binary {
	 ...
	 * @return Binary object representing num1 OR num2
	 */
	 ...
	 * @param num1 First binary number
	 * @param num2 Second binary number
	 * @return Binary object representing num1 AND num2
	 */
	 ...
	 * @param num1 First binary number
	 * @param num2 Second binary number
	 * @return Binary object representing num1 * num2
	 */
	public static Binary multiply(Binary num1, Binary num2) {
		...
		// Multiply using binary multiplication algorithm
		for (int i = n2.length() - 1; i >= 0; i--) {
			if (n2.charAt(i) == '1') {
				String temp = n1;

				// Add shift (append zeros)
